...
SoloTrace validates the final HTTPS download host, response size, returned
audio readability and duration, timeouts, and cancellation. The result is
labeled an experimental lead estimate because lead and rhythm guitars can still
